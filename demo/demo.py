...
from main.gen_word_vect import gen_word_dict_list, gen_extra_stopwords_word_dict_list
...
txt = get_all_articles(ARTICLE_PATH)[0]
tfidf_vct = gen_text_tfidf_vct(txt, ARTICLE_PATH,extra_stopwords = True)
print(tfidf_vct)
block(' ')
...
tfidf_vct_0 = gen_text_tfidf_vct(txt_0, ARTICLE_PATH, extra_stopwords= True)
tfidf_vct_1 = gen_text_tfidf_vct(txt_1, ARTICLE_PATH, extra_stopwords=True)
